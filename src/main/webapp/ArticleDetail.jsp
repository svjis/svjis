            ...
            <div id="content-main">
                <div id="content-main-in">
                    ...
                    <p class="info">
                        ...
                        <%=language.getText("by:") %> <strong><%=article.getAuthor().getFullName() %></strong><%=(article.getCommentList().size() != 0) ? ", " + language.getText("Comments:") + " <strong>" + article.getCommentList().size() + "</strong>" : "" %>
                    </p> 
