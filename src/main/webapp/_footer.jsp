...
<%@page contentType="text/html" pageEncoding="UTF-8"%>
    ...
    <div id="footer">
        ...
        <p>System <strong><a href="http://svjis.webstones.cz">SVJ IS 2.0</a></strong> Copyright &copy;&nbsp;2011 <strong><a href="mailto:jaroslav.beran@gmail.com">Jaroslav Beran</a></strong>, All Rights Reserved &reg;</p>
