...
<%@page contentType="text/html" pageEncoding="UTF-8"%>
    ...
    <div id="footer">
        ...
        <p>System <strong>SVJIS 1.5.0-SNAPSHOT</strong>, introduced 10.4.2019, <strong><a href="mailto:jaroslav.beran@gmail.com">Jaroslav Beran</a></strong>, All Rights Reserved &reg;</p>
